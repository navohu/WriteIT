...
package com.payera.payera01.swipelib;

import android.os.Bundle;
import android.view.View;

import com.payera.payera01.R;
 ...
 */
public class SetPatternActivitylib extends BasePatternActivity
    ...
    private void onRightButtonClicked() {
        if (stage.rightButtonState == RightButtonState.Continue) {
            ...
            setResult(RESULT_OK);
            String patternstr = PatternUtils.patternToString(pattern);
